...
if __name__ == '__main__':
    po_files = [
        ('translations/en/LC_MESSAGES/messages.po', 'translations/en/LC_MESSAGES/messages.mo'),
        ('translations/id/LC_MESSAGES/messages.po', 'translations/id/LC_MESSAGES/messages.mo')
    ]
